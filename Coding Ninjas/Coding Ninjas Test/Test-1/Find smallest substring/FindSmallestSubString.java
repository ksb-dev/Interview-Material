...
public class FindSmallestSubString {
	public static void main(String[] args) {
		String s1 = "Looks for minimum string";
		String s2 = "mums";

		String result = findMinSubstringContainingString(s1, s2);

		System.out.println(result);
	}

	public static String findMinSubstringContainingString(String s1, String s2){
